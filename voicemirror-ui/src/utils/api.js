...
export async function uploadAudio(file, note = '') {
  ...
  try {
    ...
    console.warn('⚠️ FastAPI unreachable — using demo mode:', err.message)
    return _demoResult()
  }
}
...
function _demoResult() {
  ...
  const demoAdvice = {
    ...
    angry: "Гнев — это энергия. Ты можешь направить её во что-то созидательное или просто выдохнуть. Я здесь, чтобы выслушать тебя. 🔥",
